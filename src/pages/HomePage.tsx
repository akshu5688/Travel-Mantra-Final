          ...
          <div className="mt-4 lg:mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
            ...
            <div className="min-w-0 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-5">
                ...
                <Link
                  to="/hotels"
                  className="btn-primary w-full sm:w-auto min-h-[44px] !bg-white !text-[#1f2a1d] hover:!bg-gradient-to-r hover:!from-[#F97316] hover:!to-[#FB923C] hover:!text-white hover:shadow-md transition-all"
                >
                  Search
                </Link>
